...
template <typename T> std::ostream& operator<<(std::ostream&, const ListElement<T>&);
...
class ListElement {
				friend std::ostream& operator<< <DATA_TYPE>(std::ostream&, const ListElement<DATA_TYPE>&);
public:
  DATA_TYPE               data; /* data stored by this element (int, double, Mixed, etc.)               */
